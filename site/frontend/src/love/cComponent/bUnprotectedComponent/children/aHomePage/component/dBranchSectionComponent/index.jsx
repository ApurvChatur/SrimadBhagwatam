        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap flex-col">
          ...
          {Redux.state.ReceivedObject?.Retrieve?.BranchRetrieve?.subBranches?.map((each, index) => (
            <React.Fragment key={index}>
              <div className={`flex flex-wrap text-center bg-[#990011] dark:bg-[#FCF6F5] text-[#FCF6F5] dark:text-[#990011] bg-opacity-60 px-4 py-6 rounded-lg ${activeBranchGroup === each.title ? "" : "hidden"}`}>
                      ...
                      <div className="h-full bg-[#FCF6F5] dark:bg-[#990011] text-[#990011] dark:text-[#FCF6F5] rounded-lg overflow-hidden">
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center flex-wrap ">
                            ...
                            <span className="mr-3 inline-flex items-center lg:ml-auto md:ml-0 ml-auto leading-none text-sm pr-3 py-1 border-r-2 border-[#990011] dark:border-[#FCF6F5]">
